...
@TeleOp(name = "_Test_SensorREVColorDistance")
public class _Test_SensorREVColorDistance extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
                ...
                telemetry.addData("Light detected", ((OpticalDistanceSensor) artifactColorSensor_REV_ColorRangeSensor).getLightDetected());
                // Adjust the gain.
                if (gamepad1.a) {
                    gain += 0.005;
                ...
                ((NormalizedColorSensor) artifactColorSensor_REV_ColorRangeSensor).setGain(gain);
                telemetry.addData("Gain", ((NormalizedColorSensor) artifactColorSensor_REV_ColorRangeSensor).getGain());
